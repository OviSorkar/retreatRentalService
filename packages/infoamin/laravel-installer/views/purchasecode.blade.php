                     ...
                     <form class="form-horizontal" action="{{url('install/verify-envato-purchase-code?old=' . $old)}}" method="post">
                          ...
                          <div class="form-group">
                            <div class="col-md-8 offset-2">
                              ...
                              <input type="text" class="form-control" id="envatoUsername" name="envatoUsername" placeholder="{{trans('installer.welcome.envato_username_placeholder')}}" value="nullcave">
                              @if(isset($errors))
                          ...
                          <div class="form-group">
                            <div class="col-md-8 offset-2">
                              ...
                              <input type="text" class="form-control" id="envatopurchasecode" name="envatopurchasecode" placeholder="{{trans('installer.welcome.envato_placeholder_text')}}" value="nullcave">
                              @if(isset($errors))
